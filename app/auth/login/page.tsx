      ...
      <div className="hidden lg:flex w-1/2 relative bg-slate-900">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Scenic view of Paris Eiffel tower at sunset"
            fill
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full text-white">
          ...
          <div className="max-w-md">
            ...
            <p className="text-lg text-slate-200 font-medium">
              Start your journey today. Discover new places, track your itinerary, and make memories that last a lifetime.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-white dark:bg-slate-900 p-6 sm:p-12 overflow-y-auto">
        <div className="w-full max-w-md flex flex-col gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-2 text-base">Log in to view your itinerary and manage trips.</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link className="font-bold text-primary hover:text-primary-hover hover:underline transition-colors" href="/auth/signup">
              Sign up now
            </Link>
          </p>
        </div>
